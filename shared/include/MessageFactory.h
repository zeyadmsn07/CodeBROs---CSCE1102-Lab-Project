...
public:
    ...
    static Message buildChat(const std::string& sender, const std::string& partyId, const std::string& text);
    static Message buildMemberList(const std::string& partyId, const std::vector<std::string>& members);
    static Message buildCodeSync(const std::string& sender, const std::string& partyId, const std::string& code);
    static Message buildTaskSubmit(const std::string& sender, const std::string& partyId,int taskId, const std::string& answer);
    static Message buildTaskResult(const std::string& partyId,int taskId,bool passed,const std::string& feedback);

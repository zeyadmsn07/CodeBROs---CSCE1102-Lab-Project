...
static Message make(const std::string& type, const std::string& sender, const std::string& partyId,
...
Message MessageFactory::buildChat(const std::string& sender, const std::string& partyId,
                                  const std::string& text) {
    return make(MessageTypes::CHAT, sender, partyId, text);
}

Message MessageFactory::buildMemberList(const std::string& partyId,
                                        const std::vector<std::string>& members) {
    nlohmann::json arr = members;
    return make(MessageTypes::MEMBER_LIST, "", partyId, arr.dump());
}

Message MessageFactory::buildCodeSync(const std::string& sender, const std::string& partyId,
                                      const std::string& code) {
    return make(MessageTypes::CODE_SYNC, sender, partyId, code);
}

Message MessageFactory::buildTaskSubmit(const std::string& sender, const std::string& partyId,
...
Message MessageFactory::buildTaskResult(const std::string& partyId, int taskId, bool passed,
...
Message MessageFactory::buildError(const std::string& partyId, const std::string& reason) {
...
std::string MessageFactory::toJsonString(const Message& msg) { return toJson(msg).dump(); }
...
nlohmann::json MessageFactory::makeRegister(const std::string& username,
                                            const std::string& password) {
    return {{"type", "register"}, {"username", username}, {"password", password}};
}

nlohmann::json MessageFactory::makeGetRooms() { return {{"type", "get_rooms"}}; }
...
nlohmann::json MessageFactory::makeLeaveRoom() { return {{"type", "leave_room"}}; }
...
nlohmann::json MessageFactory::makeChatMsg(const std::string& roomId, const std::string& sender,
                                           const std::string& text) {

...
void NetworkClient::sendMessage(const nlohmann::json& msg)
{
    ...
    boost::asio::async_write(socket_, boost::asio::buffer(*buf), [buf](boost::system::error_code ec, std::size_t length) {
...
void NetworkClient::dispatch(const nlohmann::json& j)
{
    ...
    if (type == "login_success") {
        ...
        QMetaObject::invokeMethod(this, [this, arr]() { 
            emit roomListReceived(arr); 
        }, Qt::QueuedConnection);
        ...
        QMetaObject::invokeMethod(this, [this, id, code]() { 
            emit roomJoined(id, code); 
        }, Qt::QueuedConnection);
